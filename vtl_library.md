...
**`Format_Hundreds`**: by default its value is `"SERBIAN_LONG"`, if you do not send a parameter in the method.  
If you send it, you have the option:
- `"SERBIAN_LONG"` – for the value `500` it will print `"petstotina"`
- `"SERBIAN_SHORT"` – for the value `500` it will print `"petsto"`
#### Example
